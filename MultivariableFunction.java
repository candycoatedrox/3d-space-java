public interface MultivariableFunction {
    ...
    Object evaluate(ScalarWrapper[] variables);
    ...
    Object evaluateDerivative(int v, ScalarWrapper[] variables);
    ...
    Object evaluateAntiderivative(int v, ScalarWrapper[] variables);
    ...
    Object multipleIntegrate(int[] v, ScalarWrapper[] a, ScalarWrapper[] b);
    Object multipleIntegrate(int[] v, ScalarWrapper[] a, Function[] b);
    Object multipleIntegrate(int[] v, Function[] a, ScalarWrapper[] b);
    Object multipleIntegrate(int[] v, Function[] a, Function[] b);
