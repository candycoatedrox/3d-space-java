...
public class Util {
    ...
    /**
     * Checks whether two Vectors share dimension
     * @param a a Vector
     * @param b another Vector
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Vector a, Vector b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether a Vector and a Point share dimension
     * @param a a Vector
     * @param b a Point
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Vector a, Point b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether a Vector and a Line share dimension
     * @param a a Vector
     * @param b a Line
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Vector a, Line b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether a Point and a Vector share dimension
     * @param a a Point
     * @param b a Vector
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Point a, Vector b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether two Points share dimension
     * @param a a Point
     * @param b another Point
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Point a, Point b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether a Point and a Line share dimension
     * @param a a Point
     * @param b a Line
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Point a, Line b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether a Line and a Vector share dimension
     * @param a a Line
     * @param b a Vector
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Line a, Vector b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether a Line and a Point share dimension
     * @param a a Line
     * @param b a Point
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Line a, Point b) {
        return a.getDim() == b.getDim();
    }

    /**
     * Checks whether two Lines share dimension
     * @param a a Line
     * @param b another Line
     * @return true if a and b share dimension; false otherwise
     */
    public static boolean sameDimension(Line a, Line b) {
        return a.getDim() == b.getDim();
    }
